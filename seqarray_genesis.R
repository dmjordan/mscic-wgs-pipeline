...
library(GWASTools, quietly=T, warn.conflicts=F)
library(SNPRelate, quietly=T, warn.conflicts=F)
library(SeqArray, quietly=T, warn.conflicts=F)
library(SeqVarTools, quietly=T, warn.conflicts=F)
library(GENESIS, quietly=T, warn.conflicts=F)
library(ggplot2, quietly=T, warn.conflicts=F)
library(TxDb.Hsapiens.UCSC.hg38.knownGene, quietly=T, warn.conflicts=F)
library(tidyverse, quietly=T, warn.conflicts=F)
library(qqman, quietly=T, warn.conflicts=F)
